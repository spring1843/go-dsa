...
Given a slice of unsorted integers, sort the array using the Bubble Sort algorithm.
...
To use Bubble Sort to sort a slice increasingly:
...
The name of Bubble Sort comes from the observation that smaller values bubble up to the top of the list and larger values sink lower until
the list is sorted.

To sort {2,3,1} using Bubble Sort:
1- Do not swap 2 and 3 because 2 <3.
